...
public class StudentServiceImpl extends DAO implements StudentService {
	...
	private final String INSERT = "INSERT INTO STUDENT (STUDENT_ID, STUDENT_NAME, STUDENT_DEPT, STUDENT_BIRTHDAY) "
			+ "VALUES (?, ?, ?, ?)";
	...
	public boolean isCheckId(String id) { // 학생의 학번을 비교한다.
		boolean b = true;
		...
		return b; // 존재하면 false 그렇지않으면 true를 돌려준다.
	}
