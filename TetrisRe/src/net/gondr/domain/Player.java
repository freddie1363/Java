...
public class Player {
	...
	public Player(Block[][] board) {
		...
		shape[4][0] = getPointArray("0,0:0,1:1,1:2,1");
		shape[4][1] = getPointArray("0,1:1,1:1,0:1,-1");
		shape[4][2] = getPointArray("1,1:1,0:0,0:-1,0");
		shape[4][3] = getPointArray("0,0:-1,0:-1,1:-1,2");

		// ─┐_ 모양은 여러분이 만들어보세요.
		shape[5] = new Point2D[4][];
		shape[5][0] = getPointArray("0,0:1,0:2,0:2,-1");
		shape[5][1] = getPointArray("0,0:1,0:1,1:1,2");
		shape[5][2] = getPointArray("0,0:0,-1:1,-1:2,-1");
		shape[5][3] = getPointArray("0,0:0,1:0,2:1,2");

		// ㅗ 모양은 여러분이 만들어보세요.
		shape[6] = new Point2D[4][];
		shape[6][0] = getPointArray("1,1:0,0:1,0:2,0");
		shape[6][1] = getPointArray("1,1:1,0:1,-1:2,0");
		shape[6][2] = getPointArray("0,0:1,0:2,0:1,-1");
		shape[6][3] = getPointArray("1,0:2,1:2,0:2,-1");
